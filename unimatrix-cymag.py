...
parser.add_argument('-s', '--speed',
                    help='speed, integer up to 100. Default=95',
                    default=95,
                    type=int)
...
class Writer:
    ...
    def __init__(self, screen):
        ...
        curses.init_pair(3, curses.COLOR_BLACK, curses.COLOR_WHITE)
        curses.init_pair(4, curses.COLOR_CYAN, start_bg)
        curses.init_pair(5, curses.COLOR_MAGENTA, start_bg)
        self.white = curses.color_pair(2)

    @staticmethod
    def two_color(x):
        """Randomly pick cyan or magenta per character."""
        return curses.color_pair(choice([4, 5]))
    ...
    def draw_flasher(self, flasher):
        ...
        Draws characters, included spaces to overwrite/erase characters.
        """
        color = self.two_color(flasher[1])
